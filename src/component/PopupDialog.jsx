...
export default function PopupDialog(props) {
  ...
  function getButtons(type) {
    ...
    if (type == 'OKCANCEL') {
      button = <>
        <Button onClick={props.onSubmit} variant={'contained'} >{transLangKey("OK")}</Button>
        <Button onClick={props.onClose} variant={'contained'} >{transLangKey("CANCEL")}</Button>
      </>
    } else if (type == 'CONFIRM') {
      button = <>
        <Button onClick={props.onConfirm} variant={'contained'} >{transLangKey("CONFIRM")}</Button>
      </>
    } else {
      button = <>
        <Button onClick={props.onSubmit} variant={'contained'} >{transLangKey("OK")}</Button>
