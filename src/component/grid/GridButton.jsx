...
import { exportGridtoExcel } from "./grid";
  ...
  return (
    <>
      <Tooltip title={transLangKey("DELETE")} placement='bottom' arrow>
        {component.button === 'icon' ?
          <IconButton className={iconClasses.gridIconButton} onClick={props.onClick ? props.onClick : deleteRow}><Icon.Minus size={20} /></IconButton>
  ...
  return (
    <>
      ...
      <Tooltip title={transLangKey("EXCEL_IMPORT")} placement='bottom' arrow>
        {component.button === 'icon' ?
          <IconButton className={iconClasses.gridIconButton} onClick={props.onClick ? props.onClick : importExcel}><Icon.Upload size={20} /></IconButton>
  ...
  return (
    <>
      <Tooltip title={transLangKey("EXCEL_EXPORT")} placement='bottom' arrow>
        {component.button === 'icon' ?
          <IconButton className={iconClasses.gridIconButton} onClick={props.onClick ? props.onClick : exportExcel}><Icon.Download size={20} /></IconButton>
