...
*/
import { isEmpty, isEquivalent, clone, getDateFromDateString} from '../../utils/common';

import { format } from "../../utils/format"
import wingui3 from '../../component/grid/wingui3-custom'
...
const getServiceCall = async (svcCallId, param) => {
  const response = await axios.post(`engine/dp/${svcCallId}`, {
