...
import { ZDateTimePicker } from "../component/ZDateTimePicker";
...
export function ZDateTimeRange({ onChange, value, label, readonly, disabled, min, max, minTime, maxTime,
  ...
  if (!label || typeof label === 'string') {
    pramlabel = [transLangKey("FROM_DATE"), transLangKey("TO_DATE")]
  } else {
    pramlabel = label
  }
  return (
